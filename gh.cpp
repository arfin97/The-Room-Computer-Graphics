...
/// Wallmat canvas
 ...
 /// Circle
    drawCircle(177,628,20, 255,255,0);
...
flower_b = 255;
 ...
 /// Flower Circle Background
    drawCircle(642,600,15, flower_r,flower_g,flower_b);



/// TRIANGE Left Bottom
    glColor3ub(flower_r,flower_g,flower_b);
    glBegin(GL_TRIANGLES);
    glVertex2d(620, 580);
    glVertex2d(640, 600);
    glVertex2d(640, 580);
...
/// Keyboard
    ...
    drawCircle(380,360,5, flower_r,flower_g,flower_b);
...
/// Table1 Up
   ...
   /// monitor screen
    ...
    drawCircle(792,250,5, flower_r,flower_g,flower_b);
    drawCircle(838,250,5, flower_r,flower_g,flower_b);
    drawCircle(815,235,5, flower_r,flower_g,flower_b);

    //drawCircle(790,260,5, 50,0,0);
            /// busket front
    glColor3d(0.5, 0.5, 0.5);
    glBegin(GL_POLYGON);
    glVertex2d(980, 180);
